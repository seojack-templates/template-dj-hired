...
- **Live:** https://dj-hired.templates.seojack.website
- **Registry id:** `tpl_dj_hired`
- **Showcased on:** https://seojack.net/templates/tpl_dj_hired
...
| `app/styles.ts` | one scoped CSS literal (every selector prefixed `.dj-hired-demo`) |
...
Own GitHub repo (`seojack-templates/template-dj-hired`) + own Vercel project,
production domain `https://dj-hired.templates.seojack.website`. See `docs/templates-github-org.md`.